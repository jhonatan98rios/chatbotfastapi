...
class OpenAiCompletionProvider(AbstractCompletionProvider):
    ...
    def __init__(self) -> None:
        ...
        self.footer = "Somente responda as mensagens agindo como uma API Rest e utilizando a estrutura json { answer: str, name: str, mail: str, address: str, product: str, quantity: int } como resposta. A resposta não deve conter os parametros com valor null."
    ...
    def execute(self, messages: List[ChatCompletionMessageParam]) -> Completion:
        completion = self.client.chat.completions.create(
            ...
            messages=[
                ...
                *messages,
                {"role": "system", "content": self.footer},
            ]
        )
